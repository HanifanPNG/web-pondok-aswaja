      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10" data-aos="fade-up">
          ...
          <p className="text-gray-300 text-sm sm:text-base max-w-2xl leading-relaxed">
            Informasi terbaru seputar kegiatan, prestasi, dan pengumuman Pondok Pesantren Aswaja An Nahdliyah.
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {paginated.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {paginated.map((berita) => (
              <Link
                ...
                data-aos="fade-up"
                data-aos-delay={`${(berita.id - 1) % 3 * 100}`}
              >
                {/* Image */}
                ...
                <div className="p-5 flex flex-col flex-1 justify-between bg-white text-gray-900">
                  <div>
                    ...
                    <p className="text-gray-500 text-xs sm:text-sm line-clamp-3 mb-4 leading-relaxed">
                      {berita.description}
                    </p>
                  </div>

                  {/* Footer Card */}
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100 text-gray-400">
          ...
          <div className="text-center py-16 text-gray-400">
            ...
            <p className="text-sm">Tidak ada berita yang cocok dengan pencarian Anda.</p>
          </div>
        )}
